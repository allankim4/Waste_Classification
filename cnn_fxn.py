...
#Loading 2-layer
cnn = load_model('Trained_Model/image_class1.h5')

#Loading InceptionV3
cnn2 = load_model('Trained_Model/image_class1_tl.h5')

#Loading 3-layer
cnn3 = load_model('Trained_Model/image_class2_3l.h5')

#Loading Xception
cnn3_tl = load_model('Trained_Model/image_class2_3l_tl.h5')
...
def predictor_output(path):
    ...
    print()
    print('2-LAYER CNN:')
    print(prediction_label(mod1))
    print()
    print('3-Layer CNN:')
    print(prediction_label(mod2))
    print()
    print('Inception ver3 CNN')
    print(prediction_label(mod3))
    print()
    print('Xception CNN')
    print(prediction_label(mod4))